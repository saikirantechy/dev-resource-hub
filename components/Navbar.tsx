          ...
          <div className="absolute right-0 top-0 h-full w-72 glass-strong border-l border-white/10 overflow-y-auto">
            <div className="p-6 pt-20 space-y-2">
              ...
              <div className="pt-4 border-t border-white/5 space-y-2">
                ...
                <Link href="/login" onClick={() => setMobileOpen(false)} className="flex items-center gap-2 px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white font-semibold hover:bg-white/10 transition-all">
                  <LogIn size={14} /> Login
                </Link>
              </div>
            </div>
