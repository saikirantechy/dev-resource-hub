...
import {
  ...
  Swords, BrainCircuit, Search as SearchIcon,
} from "lucide-react";
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-white/5 glass-dark" aria-label="Main navigation">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3 shrink-0">
            ...
            <Link
              href="/search"
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 transition-all text-xs font-semibold"
              aria-label="Search all resources"
            >
              <SearchIcon size={12} />
              Search
              <span className="text-[9px] text-gray-600 ml-0.5">⌘K</span>
            </Link>
            <Link
              href="/webagentcore"
          ...
          <div className="absolute right-0 top-0 h-full w-80 glass-strong border-l border-white/10 overflow-y-auto">
            <div className="p-6 pt-20 space-y-6">
              ...
              <div className="pt-4 border-t border-white/5 space-y-4">
                ...
                <Link href="/search" onClick={() => setMobileOpen(false)} className="flex items-center gap-2 px-4 py-3 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-400 font-bold hover:bg-blue-500/20 transition-all text-sm">
                  <SearchIcon size={14} /> Search All Resources
                </Link>
