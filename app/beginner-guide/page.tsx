...
import { BookOpen, Rocket, Code2, Users, ArrowRight, CheckCircle2, ChevronRight, GraduationCap } from "lucide-react";

export default function BeginnerGuidePage() {
  const steps = [
    {
      title: "Master the Basics",
      description: "Start with HTML, CSS, and JavaScript. The foundation of everything on the web.",
    ...
    },
    {
      ...
      description: "Install VS Code, Git, and Node.js. Make your local machine a powerhouse.",
    ...
    },
    {
      ...
      description: "Create a simple landing page or a To-Do list. Practice makes perfect.",
    ...
    },
    {
      ...
      description: "Contribute to open source. Start with the Dev Resource Hub!",
    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        <header className="mb-20 space-y-6">
          ...
          <h1 className="text-5xl font-black tracking-tight">The Beginner's Path</h1>
          <p className="text-xl text-gray-400 max-w-2xl leading-relaxed">
            A curated step-by-step journey to help you go from zero to your first open-source contribution.
          </p>
        </header>

        <div className="space-y-12">
          {steps.map((step, index) => (
            <div key={index} className="relative pl-12 border-l border-white/10 pb-12 last:pb-0">
              {/* Dot */}
        ...
        <div className="mt-24 p-12 rounded-3xl bg-gradient-to-br from-blue-600/20 via-transparent to-transparent border border-white/10 text-center space-y-8">
          ...
          <p className="text-gray-400 max-w-md mx-auto">
            You've learned the basics. Now, join 20+ other contributors and help us build this platform.
          </p>
