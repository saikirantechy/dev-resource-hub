#!/usr/bin/env python3
"""Generate security-center and security-dashboard pages with correct paths."""
import os

def write(path, content):
    # base is "." because basher runs inside dev-resource-hub/
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <div className="flex flex-wrap gap-3 mt-2 text-xs text-gray-400">
                    ...
                    <span className="flex items-center gap-1">&spades; {result.forks.toLocaleString()}</span>
                    <span className="flex items-center gap-1">&spades; {result.contributors}</span>
                    <span className="flex items-center gap-1">&spades; {result.openIssues}</span>
                  </div>
                </div>
              </div>
            </div>
...
import {
  Shield, TrendingUp, AlertTriangle, Github,
  Star, Clock, Users,
...
if __name__ == "__main__":
    write("app/security-center/page.tsx", SC)
    write("app/security-dashboard/page.tsx", SD)
    print("Done! Both pages generated.")
